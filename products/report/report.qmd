...
package versions used when the report was rendered. This is a lightweight way to
help users understand the computing environment without requiring a full
environment manager.
